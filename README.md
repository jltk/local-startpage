# [![local-startpage](https://u.teknik.io/w8SRz.png)](https://github.com/jltk/local-startpage/releases/tag/v0.1.4)
...
+ **Con:** Data might get lost when clearing browser cookies (Firefox) or cache (Chrome) when set to clear everything & data is browser specific
